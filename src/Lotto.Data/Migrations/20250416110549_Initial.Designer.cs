...
namespace Lotto.Data.Migrations
{
    ...
    [Migration("20250416110549_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lotto.Domain.Entities.Games.GoalDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("FootballResultId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ScoringPlayer")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Lotto.Domain.Entities.Games.GoalDetail", b =>
                {
                    b.HasOne("Lotto.Domain.Entities.Games.FootballResult", null)
                        .WithMany("Goals")
                        .HasForeignKey("FootballResultId");
                });
